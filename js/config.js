...
const CONFIG = {
  ...
  // PROFILE
  // ----------------------------------------------------------
  profileName:   "𝓝𝓸𝔁𝓝 ",      // name shown on the card
  nameTooltip:   "𝖆𝖒𝖎𝖗𝖆𝖇𝖇𝖆𝖘",         // tooltip on hover over the name
  nameEffect:    "noise",         // "noise" = TV interference | "none" = plain text
  statusText:    "𝟙𝟠 𝕪𝕖𝕒𝕣𝕤 𝕠𝕝𝕕 𝕗𝕣𝕠𝕞 𝕚𝕣𝕒𝕟", // text below the name (typewriter effect)
  tabTitle:      "@iamir_tt",      // animated browser tab title
  ...
  // ----------------------------------------------------------
  discordUsername: "! 𝐍𝐨𝐱𝐍",
  discordStatus:   "ᴏɴʟɪɴᴇ  ɪꜱ ᴘʟᴀʏɪɴɢ ...",
  ...
  // ----------------------------------------------------------
  socialLinks: [
    { name: "Instagram", url: "https://instagram.com/iamir_tt",         icon: "assets/icons/instagram.png" },
    ...
    { name: "Github",  url: "https://github.com/iamirtt",          icon: "assets/icons/github.png"  },
,
  ],
  iconSize:         "36px",
